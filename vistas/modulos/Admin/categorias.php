                        ...
                        <form action="" method="post" enctype="multipart/form-data" >
                            <div class="row">
                                <div class="col-12 col-lg-6 wow fadeInUp" data-wow-delay="100ms">
                                    <input type="text" name="name" class="form-control mb-30" placeholder="Nombre de la categoria">
                                </div>
...
<?php 
    elseif ($ruta[2] == 'edit'): 
        $category =$categoryController->getCategory('id',$ruta[1]);
?>
    <div class="roberto-contact-form-area section-padding-100">
        <div class="container">
            <div class="row">
                    ...
                    <div class="roberto-contact-form">
                        <form action="" method="post" enctype="multipart/form-data" >
                            <div class="row">
                                ...
                                <div class="col-12 col-lg-6 wow fadeInUp" data-wow-delay="100ms">
                                    <input type="text" name="name" class="form-control mb-30" placeholder="Nombre de la categoria" value=<?=$category['name']?> />
                                </div>
                                <div class="col-6 wow fadeInUp" data-wow-delay="100ms">
                                    <input type="file" name="file" class="form-control mb-30" placeholder="Imagen de la categoria">
                                    <input type="hidden" name="image" class="form-control mb-30" value=<?=$category['img']?>>
                                </div>
                                <div class="col-12 text-center wow fadeInUp" data-wow-delay="100ms">
                                ...
                                <?php
                                    $categoryController->updated($ruta[1]);
                                ?>
                        </form>
                    </div>
                </div>
...
<?php 
        ...
        $categoryController->deleted($ruta[1]);
    endif; 
?>
